  ...
  return (
    ...
    >
      <Head>
        ...
        <meta name="description" content={`${workflow} - Neural Supercomputing Platform`} />
        <meta
          name="viewport"
          content="height=device-height ,width=device-width, initial-scale=1, user-scalable=no"
        />
        <link rel="icon" href="/sc-logo.png" />
      </Head>
      {selectedConversation && (
        <main
          className={`flex h-screen w-screen flex-col text-sm bg-scb-white text-scb-dark ${lightMode}`}
        >
